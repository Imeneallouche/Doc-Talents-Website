  ...
  return (
    <div className={`bg-white-bluish w-full h-full flex flex-col flex-1`}>
      <form className="grid grid-cols-3 gap-20 bg-white border border-black rounded-lg p-50 ml-20 transform scale-90" onSubmit={handleSubmit}>
        ...
        <label className="ml-5 mt-10 text-black font-bold" htmlFor="Nom">Nom:</label>
        <input class="mb-5 p-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent" type="text" placeholder="Derbal" name="nom" defaultValue={Doctorant.nom} onChange={handleInputChange} />
        <label 
