  ...
  return (
    <div className={`bg-white-bluish w-full h-full flex flex-col flex-1`}>
      <form className="grid grid-cols-3 gap-10 bg-white border border-black rounded-lg p-10 ml-5 transform scale-90" onSubmit={handleSubmit}>
        ...
        <input class="mb-5 ml-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent text-blue" 
        type="text" 
        placeholder="Derbal text-blue" 
        name="nom" 
        defaultValue={Doctorant.nom}
        onChange={handleInputChange} 
        disabled/>
        <label 
        className="ml-5 mt-5 text-black font-bold"
        htmlFor="Prénom">Prénom:</label>
        <input class="mb-5 ml-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent text-black" 
        type="text"
         placeholder="Rayhane"
          name="prenom" 
          defaultValue={Doctorant.prenom}
           onChange={handleInputChange}
           disabled/>
        <label
        className="ml-5 mt-5 text-black font-bold"
         htmlFor="Matricule">Matricule:
         </label>
        <input class="mb-5 ml-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent text-black"
          type="text"
          id="Matricule"
          placeholder="20/0046"
           name="Matricule" 
           defaultValue={Doctorant.Id_Doctorant}
           onChange={handleInputChange}
           disabled/>
        ...
        <div className="flex flex-col">
          ...
          />
           <label 
          className="ml-5 mt-5 text-black font-bold"
          htmlFor="Situation">Type de doctorant:</label>
          <input
          class="mb-5 ml-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent text-black"
            type="text"
            ...
            name="Type_doctorant"
            id="Type_doctorant"
            defaultValue={Doctorant.Type_doctorant}
            onChange={handleInputChange}
            disabled
          />
          <label 
        ...
        <div className="flex flex-col">
          ...
          class="mb-5 mr-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent text-black"
            type="text"
            id="Premiere_inscription"
            onChange={handleDateeeChange}
            placeholder="2026"
            name="Premiere_inscription"
