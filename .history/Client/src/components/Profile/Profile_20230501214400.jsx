    ...
    <div className={`bg-white-bluish w-full h-full flex flex-col flex-1`}>
      <form className="grid grid-cols-3 gap-10 bg-white border border-black rounded-lg p-10 ml-5 transform scale-90" onSubmit={handleSubmit}>
        ...
        <input class="mb-5 ml-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent" type="text" placeholder="20/0046" name="Matricule" defaultValue={Doctorant.matricule} onChange={handleInputChange}/>
          <button class="text-white bg-teal-500 p-10 m-5 rounded-lg" type="submit">
            <Link to="/Editprofile">
            Modifier
            </Link>
            </button>
          <button class="text-white bg-teal-500 p-100 m-5 rounded-lg" type="submit">Séminaire</button>
