      ...
      <form className="grid grid-cols-3 gap-20 bg-white border border-black rounded-lg p-50 ml-20 transform scale-90" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col">
          ...
          class="mb-5 ml-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent"
            ...
            onChange={handleInputChange}
          />
          <label className="ml-5 mt-5 text-black font-bold"
          ...
          class="mb-5 ml-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent"
            ...
            onChange={handleInputChange}
          />
          <label className="ml-5 mt-5 text-black font-bold" htmlFor="Intitulé de thèse">Intitulé de thèse:</label>
          <input
          class="mb-5 ml-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent"
            type="text"
            placeholder="mn3ref"
            ...
            onChange={handleInputChange}
          />
          <label className="ml-5 mt-5 text-black font-bold" htmlFor="Intitulé sujet bis">Intitulé sujet bis:</label>
          <input
          class="mb-5 ml-5 border-b-1 border-solid border-gray-300 outline-none bg-transparent"
            type="text"
            placeholder="mn3ref"
