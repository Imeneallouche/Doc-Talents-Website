  ...
  const handleSubmit = async (event) => {
    ...
    const customStyles = {
     ...
     <div style={{
        ...
        Profile DPGR</div>
     <div>
        <form className="m-5 grow flex flex-col justify-center items-center grid grid-cols-2 gap-50 p-55 ">
        ...
        <div>
            <button className="submit-form suivant m-5 px-8 py-4 w-fit rounded-md text-white bg-green-500 ml-750 mt-0"
