     ...
     <div>
        <form className="m-10 mt-0 mb-0 grow flex flex-col justify-center items-center grid grid-cols-2 gap-50 p-55 ">
           ...
           className={`font-bold text-dark-purple focus:text-green mb-5`}>
            ...
            <input className={`bg-white border border-dark-purple mb-5 text-purple placeholder-light-purple text-sm rounded-lg p-5 focus:placeholder-black focus:border-green focus:outline-none focus:ring-0`}
                type="text"
                id="Nom"
                name="Nom"
