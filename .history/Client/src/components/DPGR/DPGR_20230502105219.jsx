     ...
     <div>
        <form className="m-10 grow flex flex-col justify-center items-center grid grid-cols-2 gap-50 p-55 ">
           ...
           className={`font-bold text-dark-purple focus:text-green`}>
            ...
            <input className={`bg-white mb- border border-dark-purple text-purple placeholder-light-purple text-sm rounded-lg p-5 focus:placeholder-green focus:border-green focus:outline-none focus:ring-0`}
                type="text"
                id="Prenom"
                name="Prenom"
