...
const DPGR = () => {
 ...
 <div>
    ...
    <div>
        <button className="submit-form suivant m-5 px-8 py-4 w-fit bg-className="submit-form suivant m-5 px-8 py-4 w-fit bg-dark-purple rounded-md text-white"
          type="submit" rounded-md text-white"
