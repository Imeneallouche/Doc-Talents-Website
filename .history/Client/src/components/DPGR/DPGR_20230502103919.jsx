...
function DPGR() {
  ...
  const handleSubmit = async (event) => {
    ...
    const customStyles = {
      ...
      return (
        <div>
     <div className=bg-gradient-to-l from-gray-900 to-indigo-700 w-350 h-55 rounded-lg flex justify-start items-center text-white text-lg font-bold font-poppins shadow-sm pl-30 mt-0 mb-0 ml-60">Profile DPGR</div>
     <div>
