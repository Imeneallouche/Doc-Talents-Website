  ...
  const handleSubmit = async (event) => {
    ...
    const customStyles = {
     ...
     <div style={{
        ...
        Profile DPGR</div>
     <div>
        <form className="m-10 mt-0 mb-grow flex flex-col justify-center items-center grid grid-cols-2 gap-50 p-55 ">
        ...
        <div>
            <button className="bg-green text-white py-2 px-4 rounded float-right mr-20 mt-0"
