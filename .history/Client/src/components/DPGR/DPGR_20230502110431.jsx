  ...
  const handleSubmit = async (event) => {
    ...
    const customStyles = {
     ...
     <div style={{
        ...
        Profile DPGR</div>
     <div>
        <form className="m-10 mt-5 grow flex flex-col justify-center items-center grid grid-cols-2 gap-50 p-55 ">
        ...
        <div>
            <button className="bg-green-500 submit-form suivant ml-750 px-8 py-4 w-fit rounded-md text-white"
