    ...
    <div className="CriteriaBar">
      <div className="flex items-center gap-24    ">
        <div>
          ...
          <select
            id="critere1"
            className="bg-dark-black border  text-black text-sm rounded-lg focus:ring-dark-green focus:border-black block w-full p-2.5 dark:bg-dark-green dark:border-black dark:placeholder-blackdark:text-black dark:focus:ring-black dark:focus:border-black"
          ...
          >
            ...
            <optgroup label="Situation">
              ...
              <option value="soutenu">Soutenu(e)</option>
              <option value="abondon">Abondon(e)</option>
              <option value="radie">Radié(e)</option>
            </optgroup>
            <optgroup label="Nbr d'année d'inscription">
              <option value="inf5">Inférieur à 5 ans</option>
        ...
        <div>
          ...
          <select
            id="critere2"
            className="bg-dark-green border border-black text-gray-900 text-sm rounded-lg focus:ring-dark-green focus:border-dark-green block w-full p-2.5 dark:bg-dark-green dark:border-black dark:placeholder-black dark:text-black dark:focus:ring-blackdark:focus:border-black"
