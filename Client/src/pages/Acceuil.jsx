      ...
      <nav className="flex justify-between items-center pr-[100px] pl-[100px] pt-8 pb-8">
        ...
        <ul className="flex">
          <li className="mr-[80px] text-white font-semibold">
            <a
              target="_blank"
              href="https://drive.google.com/file/d/1yZ9n175QsziEgXqmrSQgccNbpT1ACCZD/view?usp=sharing"
            >
              Aide
            </a>
          </li>
      ...
      <section className="main flex justify-between items-center pr-[100px] pl-[100px]">
        <div className="sec1">
          ...
          <p className="text-white font-light leading-10 mt-4">
            Dédié à la gestion des inscriptions, recherches et statistiques sur
            les doctorants. On fourni une plateforme complète et efficace pour
            le suivi de toutes les informations liées aux étudiants en doctorat.{" "}
          </p>
