...
function Statistics() {
  ...
  const handleCriteriaChange = async (critere1, critere2, premiere_annee, derniere_annee) => {
      ...
      <div className="flex flex-col justify-start ml-64">
        ...
        <CriteriaBar onCriteriaChange={handleCriteriaChange} />
          ...
          <div className="flex flex-col">
            <div className="mt-10">
            <BarChart data={data} critere1={critere1} critere2={critere2} startYear={startYear} endYear={endYear} />
            
            </div>
            
          <div className="absolute right-0 mt-1/2 p-16 mr-4">
          <div className="flex gap-12 mt-12">
            <Cards title={critere1}s count={`${data.nbDoctorants} Doctorants`} />
